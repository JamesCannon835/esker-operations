...
const AREAS: Area[] = [
  ...
  { href: "/verti-block", label: "Verti-Block", sub: "Weekly production", emoji: "🧱", color: "#8a5a3a" },
  { href: "/verti-block/loads", label: "Verti Loads", sub: "Build & weigh a load", emoji: "🚚", color: "#5b6a4a" },
